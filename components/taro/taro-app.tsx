...
import { WorkspacePanelCollapsedVariants } from './workspace-panel-collapsed-variants';
  ...
  return (
    <div className="h-full flex flex-col bg-background font-sans relative">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Panel - Workspace (warehouses + comparisons) — vartest5 collapsed state */}
        <WorkspacePanelCollapsedVariants
